...
import { getFullEstateDescription } from './utils/format.js';
import { searchEstates } from './sreality/search.js';
import { fetchEstateDetails } from './sreality/details.js';
import type { EstateDetails } from './sreality/details.js';
...
for (let page = 1; page <= PAGES; ++page) {
  ...
  await fsp.writeFile(`./estates/page-${page}.json`, JSON.stringify(estates, null, 2), 'utf-8');
}
